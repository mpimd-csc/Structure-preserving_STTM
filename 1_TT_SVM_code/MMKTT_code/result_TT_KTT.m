...
[CVofTT_HSI_indiana,trainTIMEofTT_HSI_indiana,testTIMEofTT_HSI_indiana] = KTTMain_lib(X,label,data_TT2,data_TT,t);

end
save('CVofTT_HSI_indiana.mat','CVofTT_HSI_indiana') % mat file for accuracy output

l = 1:1:10;
idxmax1 = find(CVofTT_HSI_indiana == max(CVofTT_HSI_indiana)); % maximum accuracy
% plotting accuracy vs TT rank
plot(l,CVofTT_HSI_indiana, '--s',...
...
% main results including training and testing
[CVofTT_HSI_Salines,trainTIMEofTT_HSI_salines,testTIMEofTT_HSI_salines] = KTTMain_lib(X,label,data_TT2, data_TT,t);

end
save('CVofTT_HSI_Salines.mat','CVofTT_HSI_Salines') % mat file for accuracy output

l = 1:1:10;
idxmax1 = find(CVofTT_HSI_Salines == max(CVofTT_HSI_Salines)); % maximum accuracy
% plotting accuracy vs TT rank
plot(l,CVofTT_HSI_Salines, '--s',...
    'MarkerIndices',1:1:length(l),...
    'LineWidth',2,...
    'MarkerSize',10,...
    'MarkerFaceColor',[0.5,0.5,0.5],...
...
% computing TT of input tensor
[ data_TT2 ] = TTmat( X, data_TT);

% main results including training and testing
[CVofTT_ADNI(l),trainTIMEofKrndTT_ADNI,testTIMEofKrndTT_ADNI] = KTTMain_lib(X,label,data_KTT2_rnd,data_TT,t);


end

l = 1:1:10;
save('CVofTT_ADNI.mat','CVofTT_ADNI') % mat file for accuracy output 
idxmax1 = find(CVofTT_ADNI == max(CVofTT_ADNI)); % maximum accuracy 

% plotting accuracy vs TT rank
plot(l,CVofTT_ADNI, '--s',...
    'MarkerIndices',1:1:length(l),...
    'LineWidth',2,...
    'MarkerSize',10,...
    'MarkerFaceColor',[0.5,0.5,0.5],...
...
% main results including training and testing
[CVofTT_ADHD(l),trainTIMEofTT_ADHD,testTIMEofTT_ADHD] = KTTMain_lib(X,label,data_TT2,data_TT,t);

end

l = 1:1:10;
save('CVofTT_ADHD.mat','CVofTT_ADHD') % saving accuracy mat file
idxmax1 = find(CVofTT_ADHD == max(CVofTT_ADHD)); % maximum accuracy
% plotting accuracy vs TT rank
plot(l,CVofTT_ADHD, '--s',...
    'MarkerIndices',1:1:length(l),...
    'LineWidth',2,...
    'MarkerSize',10,...
    'MarkerFaceColor',[0.5,0.5,0.5],...
